                ...
                <div className="card-body pt-3">
                    <form action="" encType="multipart/form-data" onSubmit={submitHandler}>
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input defaultValue={data.price} type="number" ref={price_field} step={2} className='form-control' name='price' />
                            <ul>
                                {formErrors?.price}
                            </ul>
                        </div>
                        <div className="form-group mb-3">
                            ...
                            <input max={100} defaultValue={data.discount} onKeyUp={discountHandler} ref={discount_field} type="number" className='form-control' name='discount' />
                            <ul>
                                {formErrors?.discount}
                            </ul>
                        </div>
                        <div className="form-group mb-3">
                            ...
                            <input readOnly defaultValue={data.discount_price} step=".00" ref={discount_price_field} type="number" className='form-control' name='discount_price' />
                            <ul>
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input type="date" defaultValue={data.discount_date?.split('T')[0]} className='form-control' name='discount_date' />
                            <ul>
