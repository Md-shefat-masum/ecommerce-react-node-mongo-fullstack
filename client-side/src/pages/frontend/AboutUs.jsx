                                ...
                                <div className="about-page">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6 col-sm-12">
                                                <div className="about-us">
                                                    ...
                                                    <p>
                                                        quis nostrud exercitation ullamcorper suscipit lobortis nisl ut
                                                        aliquip.
                                                    </p>
                                                    <button className="btn btn-primary" name="continue" type="submit"> Shop
                                                        Now </button>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-sm-12">
                                    ...
                                    <div className="block-title">
                                        ...
                                        <p>Leverage agile frameworks to provide a robust synopsis for high level
                                            overviews. Iterative to corporate strategy to the table win-win survival
                                            strategies to ensure</p>
                                    </div>
