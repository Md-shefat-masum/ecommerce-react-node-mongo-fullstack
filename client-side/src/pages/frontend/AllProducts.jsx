                            ...
                            <div id="_desktop_left_column" className="col-xs-12 col-sm-12 col-md-12 col-lg-3">
                                <div id="left-column">
                                                    ...
                                                    <ul className="category-sub-menu">
                                                        ...
                                                        <li data-depth={0}>
                                                            ...
                                                            <div className="collapse" id="exCollapsingNavbar8">
                                                                <ul className="category-sub-menu">
                                                                    <li data-depth={1}>
                                                                        <a className="category-sub-link" href="#">Casual
                                                                            Dresses</a>
                                                                    </li>
                                                                    <li data-depth={1}>
                                                                    ...
                                                                    <li data-depth={1}>
                                                                        <a className="category-sub-link" href="#">Summer
                                                                            Dresses</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                    ...
                                    <section className="featured-products clearfix mt-3">
                                        <h3 className="h1 products-section-title block-title hidden-md-down">New products
                                        </h3>
                                            ...
                                            <div className="products">
                                                <article className="product-miniature js-product-miniature">
                                                    <div className="product-container">
                                                        ...
                                                        <div className="caption">
                                                            <div className="product-title"><a href="#">Pellentesque et
                                                                pharetra</a></div>
                                                ...
                                                <article className="product-miniature js-product-miniature">
                                                    <div className="product-container">
                                                        ...
                                                        <div className="caption">
                                                            <div className="product-title"><a href="#">Vis feugiat
                                                                delenit</a></div>
                                                            <div className="product-price-and-shipping">
                                                                <span className="sr-only">Regular price</span>
                                                ...
                                                <article className="product-miniature js-product-miniature">
                                                    <div className="product-container">
                                                        ...
                                                        <div className="caption">
                                                            <div className="product-title"><a href="#">Curabitur laoret
                                                                luctus</a></div>
                                                            <div className="product-price-and-shipping">
                                                                <span className="sr-only">Price</span>
                                                ...
                                                <article className="product-miniature js-product-miniature">
                                                    <div className="product-container">
                                                        ...
                                                        <div className="caption">
                                                            <div className="product-title"><a href="#">Aliquam fringilla
                                                                juste</a></div>
                                                            <div className="product-price-and-shipping">
                                                                <span className="sr-only">Price</span>
                                    ...
                                    <section className="featured-products clearfix mt-3">
                                        <h3 className="h1 products-section-title block-title hidden-md-down">Popular
                                            Products</h3>
                                            ...
                                            <div className="products">
                                                <article className="product-miniature js-product-miniature">
                                                    <div className="product-container">
                                                        ...
                                                        <div className="caption">
                                                            <div className="product-title"><a href="#">Simul dolorem
                                                                voluptaria</a></div>
                                                            <div className="product-price-and-shipping">
                                                                <span className="sr-only">Price</span>
                                                ...
                                                <article className="product-miniature js-product-miniature">
                                                    <div className="product-container">
                                                        ...
                                                        <div className="caption">
                                                            <div className="product-title"><a href="#">Omnis dicam
                                                                mentitum</a></div>
                                                            <div className="product-price-and-shipping">
                                                                <span className="sr-only">Price</span>
                                                ...
                                                <article className="product-miniature js-product-miniature">
                                                    <div className="product-container">
                                                        ...
                                                        <div className="caption">
                                                            <div className="product-title"><a href="#">Vidit dolore eu
                                                                qui</a></div>
                                                            <div className="product-price-and-shipping">
                                                                <span className="sr-only">Price</span>
                                ...
                                <section id="main">
                                    ...
                                    <div className="category-info">
                                        ...
                                        <div id="category-description">
                                            ...
                                            <p>shoes, accessories, printed t-shirts, feminine dresses, women's jeans!
                                            </p>
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="row sort-by-row">
                                                        ...
                                                        <div className="col-sm-9 col-xs-12 col-md-9 products-sort-order dropdown">
                                                            ...
                                                            <div className="dropdown-menu">
                                                                ...
                                                                <a rel="nofollow" href="#" className="select-list js-search-link">Price, low to
                                                                    high</a>
                                                                <a rel="nofollow" href="#" className="select-list js-search-link">Price, high to
                                                                    low</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-sm-12 hidden-md-up showing">Showing 1-20 of 20 item(s)
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="js-product-list">
                                            <div className="products row">
                                                    ...
                                                    <div className="product-container product-thumb">
                                                        ...
                                                        <div className="caption">
                                                            ...
                                                            <p className="description">
                                                                ...
                                                                2560 x 1600 pixel resolution. Designed sp..</p>
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">autem euaiure</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Authletic Stud</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Black Tour Bag</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Crinkle Leaf</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Shake Spin Lion</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Sensory Sweet</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Link 'n Go Pack</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Scoop ’n Bath</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Comdaq Stroller</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Brown cushion</a>
                                                            </div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                                ...
                                                <article className="product-miniature js-product-miniature col-xs-12 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                                                    <div className="product-container product-thumb">
                                                        <div className="product-desc">
                                                            <div className="product-title"><a href="#">Classic Fisher
                                                                Gift</a></div>
                                                            <div className="product-comments">
                                                                <div className="star_content">
                                                                    <div className="star star_on" />
                                            ...
                                            <div className="pagination">
                                                <div className="col-xl-4 col-lg-5 col-md-5 col-xs-12 pagination-desc">
                                                    Showing 1-15 of 19 item(s)</div>
