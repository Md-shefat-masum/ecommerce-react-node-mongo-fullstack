                                ...
                                <section id="main">
                                            ...
                                            <div className="product-information">
                                                ...
                                                <div className="product-comments display_comments">
                                                    ...
                                                    <div className="comment_advice">
                                                        <a href="#tab-review" className="read_comment scrollLink"><i className="material-icons comments" aria-hidden="true"></i>Read Reviews</a>
                                                        <a href="#tab-review" className="write_comment scrollLink"><i className="material-icons comments" aria-hidden="true"></i>Write Review</a>
                                                    </div>
                                                    <span>5 review</span>
                                                </div>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <div className="block-reassurance-item">
                                                                        ...
                                                                        <span className="h6">Security policy (edit with
                                                                ...
                                                                <li>
                                                                    <div className="block-reassurance-item">
                                                                        ...
                                                                        <span className="h6">Delivery policy (edit with
                                                                            Customer reassurance module)</span>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div className="block-reassurance-item">
                                                                        ...
                                                                        <span className="h6">Return policy (edit with
                                                                            Customer reassurance module)</span>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                    ...
                                    <div className="row product-block-information">
                                            ...
                                            <div className="tabs">
                                                <ul className="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li className="nav-item">
                                                        <a className="nav-link" data-toggle="tab" href="#product-details" role="tab" aria-controls="product-details">Product
                                                            Details</a>
                                                    </li>
                                                    <li className="nav-item">
                                                    ...
                                                    <div className="tab-pane fade show active" id="description" role="tabpanel">
                                                        <div className="product-description">
                                                            <p>Fashion has been creating well-designed collections since
                                                                2010. The brand offers feminine designs delivering
                                                                stylish separates and statement dresses which have since
                                                                evolved into a full ready-to-wear collection in which
                                                                every item is a vital part of a woman's wardrobe. The
                                                                result? Cool, easy, chic looks with youthful elegance
                                                                and unmistakable signature style. All the beautiful
                                                                pieces are made in Italy and manufactured with the
                                                        ...
                                                        <form className="form-horizontal " id="form-review">
                                                            ...
                                                            <div className="form-group required">
                                                                <div className="col-sm-12">
                                                                    ...
                                                                    <div className="help-block"> HTML is not translated!
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="form-group required">
                                        ...
                                        <section className="product-accessories-block clearfix">
                                            <h3 className="home-title"><span className="title-icon"><span /></span>You
                                                might also like</h3>
                                            <div className="block_content">
                                                <div id="ishi-product-accessories" className="owl-carousel">
                                                    <div className="product-thumb">
                                                        <div className="item">
                                                            <div className="product-desc">
                                                                <div className="product-title"><a href="#">Authletic
                                                                    Stud</a></div>
                                                    ...
                                                    <div className="product-thumb">
                                                        <div className="item">
                                                            <div className="product-desc">
                                                                <div className="product-title"><a href="#">Skillofun
                                                                    Junior</a></div>
                                                                <div className="product-comments">
                                                                    <div className="star_content">
                                                                        <div className="star star_on" />
                                                    ...
                                                    <div className="product-thumb">
                                                        <div className="item">
                                                            <div className="product-desc">
                                                                <div className="product-title"><a href="#">corporis
                                                                    suscipit</a></div>
                                                                <div className="product-comments">
                                                                    <div className="star_content">
                                                                        <div className="star star_on" />
                                                    ...
                                                    <div className="product-thumb">
                                                        <div className="item">
                                                            <div className="product-desc">
                                                                <div className="product-title"><a href="#">Aroma Mocha</a>
                                                                </div>
                                                                <div className="product-comments">
                                                                    <div className="star_content">
                                                                        <div className="star star_on" />
                                        ...
                                        <section id="ishispecialproducts">
                                            <h3 className="home-title"><span className="title-icon"><span /></span>Special
                                                Products</h3>
                                            <div className="block_content">
                                                <div id="ishispecialproducts-carousel" className="owl-carousel products">
                                                    <div className="product-thumb">
                                                        <div className="item">
                                                            <div className="product-desc">
                                                                <div className="product-title"><a href="#">Shake Spin
                                                                    Lion</a></div>
                                                                <div className="product-comments">
                                                                    <div className="star_content">
                                                                        <div className="star star_on" />
                                                    ...
                                                    <div className="product-thumb">
                                                        <div className="item">
                                                            <div className="product-desc">
                                                                <div className="product-title"><a href="#">Link 'n Go
                                                                    Pack</a></div>
                                                                <div className="product-comments">
                                                                    <div className="star_content">
                                                                        <div className="star star_on" />
                                                    ...
                                                    <div className="product-thumb">
                                                        <div className="item">
                                                            <div className="product-desc">
                                                                <div className="product-title"><a href="#">Critter Teddy</a>
                                                                </div>
                                                                <div className="product-comments">
                                                                    <div className="star_content">
                                                                        <div className="star star_on" />
                                                    ...
                                                    <div className="product-thumb">
                                                        <div className="item">
                                                            <div className="product-desc">
                                                                <div className="product-title"><a href="#">Comfort Vibe</a>
                                                                </div>
                                                                <div className="product-comments">
                                                                    <div className="star_content">
                                                                        <div className="star star_on" />
